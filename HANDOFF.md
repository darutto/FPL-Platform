...
| ~~`run_phase2g_tests.py`~~ | 2g — tiers | 160 | retired; ported to `fpl-captain-engine/tests/test_captain_tiers.py` + `fpl-tool-contract/tests/test_captain_tier_integration.py` |
| ~~`run_phase2h_tests.py`~~ | 2h — role signals | 165 | retired; ported to `fpl-captain-engine/tests/test_role_evaluator.py` (role→tier sections not ported — see issue #69) |
