...
def test_documented_example_matches_actual_generator() -> None:
    expected = contract_player_id("José O'Neil", "2000-01-02")
    assert expected == "player_365f648bdd9b01f5504c074e"
