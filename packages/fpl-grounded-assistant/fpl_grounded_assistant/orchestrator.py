...
_SYSTEM_PROMPT: str = (
    ...
    "  FPL_TACTICAL  (zonal defence: where a team concedes, weak zones, which players\n"
    "                 exploit/fit/attack those zones)\n"
    ...
    "  FPL_TACTICAL  → asks WHERE/HOW a team concedes → get_zonal_weakness(team).\n"
    "                  asks WHICH PLAYERS exploit/fit/attack a team's weak zones\n"
