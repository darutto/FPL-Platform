...
_SYSTEM_PROMPT: str = (
    ...
    "  FPL_DATA      → bootstrap tools (find_players, get_player_snapshot, get_player_history,\n"
    "                  get_fixtures_for_gw, get_gameweek_context, get_team_snapshot, etc.)\n"
    ...
    "                  'N {position} players' + value/budget/calendar/fixture language\n"
    "                  (\"5 value midfielders with good fixtures\", \"cheap defenders with\n"
    "                  easy calendar\") → get_transfer_suggestion FIRST: it already ranks\n"
    "                  by form+fixture-difficulty (avg_fdr) AND filters by position/price\n"
    "                  in one call. A mention of 'season'/'start of the season' describes\n"
    "                  WHEN, not a request for the GW number — do not call\n"
    "                  get_gameweek_context for a player-recommendation question just\n"
    "                  because it names the season.\n"
