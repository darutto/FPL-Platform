...
def _player_snapshot_meta_dict(ps: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "expected_goals_per_90":        ps.expected_goals_per_90,
        "expected_assists_per_90":      ps.expected_assists_per_90,
        "expected_goal_involvements_per_90": ps.expected_goal_involvements_per_90,
        "ict_index_per_90":             ps.ict_index_per_90,
        "defensive_contribution":       ps.defensive_contribution,
        "defensive_contribution_per_90": ps.defensive_contribution_per_90,
