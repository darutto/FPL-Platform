...
ok(len(_tools_ant_none) == 26,                  "C2: _build_tools(None) has 26 entries")
...
ok(len(_tools_ant_expl) == 26,                  "C5: _build_tools(ANTHROPIC) has 26 entries")
...
ok(len(_tools_oai) == 26,                       "C8: _build_tools(OPENAI) has 26 entries")
...
ok(len(_decls) == 26,                           "C13: Gemini wrapper has 26 function_declarations")
